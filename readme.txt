1. Đối với các thuật toán HUOPM và HUOPMIL
	Thư mục HUOPM lập trình thuật toán HUOPM
	Thư mục HUOMIL lập trình thuật toán HUOMIL
	Thư mục HUOMIL_Parallel lập trình thuật toán HUOMIL sử dụng phương pháp xử lý song song
	Thư muc HUOMIL_Parralel_And_Reduce_Memory sử dụng phương pháp xử lý song song và áp dụng biện pháp giảm bộ nhớ
